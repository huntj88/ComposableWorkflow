...
| B-API-011 | integration | packages/workflow-server/test/integration/api/definitions-list-conformance.spec.ts | WS-25 | passing | required |
...
| ITX-035 | integration | packages/workflow-server/test/integration/api/definitions-list-conformance.spec.ts | WS-25 | passing | required |
