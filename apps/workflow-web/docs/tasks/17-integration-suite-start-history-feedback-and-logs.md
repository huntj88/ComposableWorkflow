# WEB-17 - Integration Suite: Start Workflow, History, Feedback, and Logs Delta
...
## Objective
Add deterministic integration coverage for the staged spec delta: start workflow flows, transition-history rendering and coordination, feedback single-select enforcement, and logs windowing/live-update semantics.
...
- Route, history, feedback, and logs semantics from `workflow-web-spec.md` Sections 4, 6, 8.6, 8.7, 9.3, and 10.3

## Implementation Tasks
- [ ] Extend integration fixtures/harness support for definitions lists, start-workflow responses, nested child histories, and windowed log replay.
...
## Acceptance Criteria
- Every new retained integration case has a deterministic exact spec file.
- Harness fixtures support start-workflow, nested child-history, and log-windowing scenarios without ad-hoc per-test setup drift.
- History/log assertions are semantic and deterministic rather than screenshot-based.
